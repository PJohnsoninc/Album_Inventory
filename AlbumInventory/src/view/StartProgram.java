...
public class StartProgram {
		...
		private static void addAlbum() {
			...
			AlbumList toAdd = new AlbumList(artist, title);
		...
		private static void deleteAlbum() {
			...
			String title = in.nextLine();
			AlbumList toDelete = new AlbumList(artist, title);
		...
		private static void editAlbum() {
			...
			if (!foundAlbums.isEmpty()) {
				...
				System.out.println("Retrieved " + toEdit.getArtist() + " and " + toEdit.getTitle());
